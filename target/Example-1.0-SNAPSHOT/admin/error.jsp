...
<body>
	...
	<div class="jumbotron text-center">
        <p class="lead">
        	<br>
        	<br>
        	<div class="alert alert-danger" role="alert">No se ha podido validar su identidad <a href="<s:url namespace='/admin' action='login'/>" class="alert-link">Intentar de nuevo</a>
        	</div>
     	</p>
    </div>
	<div class="container-fluid">

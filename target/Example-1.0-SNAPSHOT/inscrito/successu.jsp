    ...
    <body>
        ...
        <div class="jumbotron text-center">
            <p class="lead">
                <br>
                <br>
            <div class="alert alert-success" role="alert">¡La inscripción ha sido actualizada!. <a href="<s:url namespace='/admin' action='index'/>" class="alert-link">Volver al inicio</a>
            </div>
        </p>
    </div>
    <div class="container-fluid">

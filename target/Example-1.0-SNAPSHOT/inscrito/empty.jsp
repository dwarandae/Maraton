    ...
    <body>
        ...
        <div class="jumbotron text-center">
            <p class="lead">
                <br>
                <br>
            <div class="alert alert-danger" role="alert">Nadie se ha inscrito a ninguna maratón. <a href="<s:url namespace='/admin' action='index'/>" class="alert-link">Ir al inicio</a>
            </div>
        </p>
    </div>
    <div class="container-fluid">

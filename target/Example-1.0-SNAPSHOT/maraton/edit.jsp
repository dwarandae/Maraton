...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <link rel="stylesheet" type="text/css" href="/Maraton/bootstrap/css/bootstrap.min.css">
        <link rel="stylesheet" type="text/css" href="/Maraton/bootstrap/css/bootstrap-theme.min.css">
        ...
        <script type="text/javascript">
            $(function () {
                $("#fechaInicio").datepicker({format: "dd/mm/yy", language: 'es'})
            });
            $(function () {
                $("#fechaFin").datepicker({format: "dd/mm/yy", language: 'es'})
            });
            $(function () {
                $("#fecha").datepicker({format: "dd/mm/yy", language: 'es'})
            });
        </script>
        <title>Editar maratón</title>
    </head>
    <body>
        <nav id="myNavbar"
        ...
        <div class="jumbotron">
            <div class="container-fluid">
                ...
                <form action="maraton/action/maraton/updateMaraton.action" class="form-horizontal" method="post">

                    <div class="form-group">
                        <s:hidden name="maraton.id" id="idMaraton"/>

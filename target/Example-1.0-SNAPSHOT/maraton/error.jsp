...
<body>
	...
	<div class="jumbotron text-center">
        <p class="lead">
        	<br>
        	<br>
        	<div class="alert alert-danger" role="alert">Ups. Las fechas seleccionadas no son coherentes. <a href="<s:url namespace='/maraton' action='create'/>" class="alert-link">Intentar de nuevo</a>
        	</div>
     	</p>
    </div>
	<div class="container-fluid">

    ...
    <body>
        ...
        <div class="jumbotron text-center">
            <p class="lead">
                <br>
                <br>
            <div class="alert alert-danger" role="alert">No se ha creado ninguna maratón. <a href="<s:url namespace='/maraton' action='create'/>" class="alert-link">Crear una maratón</a>
            </div>
        </p>
    </div>
    <div class="container-fluid">

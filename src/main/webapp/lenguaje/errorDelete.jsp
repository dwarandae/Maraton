    ...
    <body>
        ...
        <div class="jumbotron text-center">
            <p class="lead">
                <br>
                <br>
            <div class="alert alert-danger" role="alert">El lenguaje no se puede eliminar porque hay maratones en este lenguaje. <a href="<s:url namespace='/admin' action='index'/>" class="alert-link">Volver al inicio</a>
            </div>
        </p>
    </div>
    <div class="container-fluid">

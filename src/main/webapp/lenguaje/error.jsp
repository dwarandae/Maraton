...
<html lang="en">
    ...
    <body>
        ...
        <p class="lead">
        	<br>
        	<br>
        	<div class="alert alert-danger" role="alert">Ups. La información ingresada es incompleta. <a href="<s:url namespace='/lenguaje' action='create'/>" class="alert-link">Intentar de nuevo</a>
        	</div>
     	</p>
    </div>
    <div class="container-fluid">

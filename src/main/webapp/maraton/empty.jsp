...
<body>
	...
	<div class="jumbotron text-center">
        <p class="lead">
        	<br>
        	<br>
        	<div class="alert alert-danger" role="alert">Ups, no hay maratones disponibles para inscribirse en el momento. <a href="<s:url namespace='/' action='index'/>" class="alert-link">Ir al inicio</a>
        	</div>
     	</p>
    </div>
	<div class="container-fluid">

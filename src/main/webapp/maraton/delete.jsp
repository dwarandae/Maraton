    ...
    <body>
        ...
        <div class="jumbotron text-center">
            <p class="lead">
                <br>
                <br>
            <div class="alert alert-success" role="alert">¡La maratón ha sido eliminada! Las inscripciones a la maratón también se han eliminado.<a href="<s:url namespace='/admin' action='index'/>" class="alert-link">Volver al inicio</a>
            </div>
        </p>
    </div>
    <div class="container-fluid">

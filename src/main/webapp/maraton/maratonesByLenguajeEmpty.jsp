    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="<s:url namespace='/admin' action='index'/>">Inicio</a></li>
                        <li><a
        ...
        <div class="jumbotron text-center">
            <p class="lead">
                <br>
                <br>
            <div class="alert alert-danger" role="alert">No existe ninguna maratón en el lenguaje seleccionado. <a href="<s:url namespace='/maraton' action='create'/>" class="alert-link">Crear una maratón</a>
            </div>
        </p>
    </div>
    <div class="container-fluid">

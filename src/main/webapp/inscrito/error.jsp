...
<body>
	...
	<div class="jumbotron text-center">
        <p class="lead">
        	<br>
        	<br>
        	<div class="alert alert-danger" role="alert">No te puedes inscribir, no hay maratones activas en el momento. Sigue preparándote y vuelve a mirar aquí pronto. <a href="<s:url namespace='/' action='index'/>" class="alert-link">Ir al inicio</a>
        	</div>
     	</p>
    </div>
	<div class="container-fluid">
